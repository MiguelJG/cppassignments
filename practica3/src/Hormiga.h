...
public:
  ...
  /** \brief girar_izquierda
    *
    * Gira la hormiga una direccion hacia la izquierda
    */
  void girar_izquierda();

  /** \brief girar_derecha
    *
    * Gira la hormiga una direccion hacia la derecha
    */
  void girar_derecha();

  /** \brief mover
    *
    * Mueve la hormiga en la direccion a la que apunta
    */
  void mover();

  /** \brief next_pos
    * Clase virtual que ha de ser implementada en las hormigas hijas
    ...
    */
  virtual int next_pos(int color) = 0;
